...
import { 
  ...
  DollarSign, Settings, ChevronRight, ChevronLeft, Home, Activity, Bot
} from 'lucide-react';
    ...
    <aside className={cn(
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className={cn(
          ...
          <p className={marketStatus.isOpen ? "text-success" : "text-muted-foreground"}>
            {marketStatus.message}
          </p>
          <p className="text-[10px]">{marketStatus.timeUntilChange}</p>
        </div>
      </div>
    </aside>
  );
